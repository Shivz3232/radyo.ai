      ...
      <div className="search-input-field">
        <div className="relative flex w-full flex-wrap items-stretch mb-3 align-center">
          ...
          <input
            ...
            className={`${'px-3 py-4 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-base border-0 shadow outline-none focus:outline-none focus:ring-2 focus:ring-indigo-600 w-full pr-10'} ${
              data.searched ? 'pl-10' : ''
            }`}
          />
